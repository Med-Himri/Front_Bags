...
export default function AddAIProductCMS() {
  ...
  /* ================= Variants (Colors & Sizes) — manual, not AI-generated ================= */
  const addVariant = () => {
      ...
      <form onSubmit={handleSubmit} className="max-w-[1000px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          <div className="lg:col-span-7 space-y-6">
            ...
            {/* Colors & Sizes — manual, NOT generated by AI */}
            <div className="bg-white p-6 lg:p-10 rounded-[2.5rem] border border-[#D4AF37]/20 shadow-xs space-y-4">
              ...
              <p className="text-[10px] text-[#626060] -mt-2">
                Entered manually — the AI does not generate colors, sizes, or stock counts.
              </p>
