        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-6">
            <div className="lg:sticky lg:top-32 space-y-6 lg:pl-4">
              ...
              {/* Stock status + variant picker + Add to Cart — combined
                  since they need to share which variant is selected */}
              ...
              <div className="pt-6 border-t border-[#D9C3B0]/30 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[11px] text-[#2D2522]/50 font-normal leading-tight">
                      Enjoy complimentary delivery on all orders across Morocco.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[11px] text-[#2D2522]/50 font-normal leading-tight">
                      Crafted with fine materials and superior finish for bags & footwear.
                    </p>
                  </div>
                </div>
              </div>
